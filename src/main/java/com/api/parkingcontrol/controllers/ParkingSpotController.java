...
public class ParkingSpotController {
    ...
    @GetMapping(value = "/{id}")
    public ResponseEntity<Object> getOneParkingSpEntity(@PathVariable(value = "id") UUID id) {
    ...
    public ResponseEntity<Object> deleteParkingSpot(@PathVariable(value = "id") UUID id){
        ...
        return ResponseEntity.status(HttpStatus.OK).body("Parking spot deleted sussessfully.");
    }
